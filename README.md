...
|---|---|---|
| Functional Analysis v1.0 | Functional and non-functional requirements, use cases, stakeholders | 🔄 In progress |
| User Stories v1.0 | User stories with acceptance criteria | ⏳ Pending |
